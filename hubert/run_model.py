...
from .utils import PROCESSORS, NUM_LABELS_TASK, TASK_TYPE
from .modules.model import BertForSequenceClassification_tpr
from .utils import evaluate
from .utils import predict
from .utils import prepare_data_loader, prepare_model, prepare_optim
from .utils import modify_model, decay
    ...
    if args.do_eval and (args.local_rank == -1 or torch.distributed.get_rank() == 0):
        ...
        eval_dataloader, all_guids, token_pos, token_ner = \
            prepare_data_loader(args, processor, label_list, task_type, all_tasks[-1],
                                tokenizer, pos_tagger, ner_tagger, split=split, return_pos_tags=return_pos_tags,
